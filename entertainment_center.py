...
THEMASK = media.Movie(
    ...
    'https://images-na.ssl-images-amazon.com/images/M/MV5BMjA5NDU3NTYzM15BMl5BanBnXkFtZTYwMzYxMjQ5._V1_.jpg',  # noqa
...
TERMINATOR = media.Movie(
    ...
    'https://s-media-cache-ak0.pinimg.com/236x/92/ed/43/92ed43c0eb8ef6126a5bd02170476a4a--terminator-poster-the-terminator.jpg',  # noqa
    'https://www.youtube.com/watch?v=c4Jo8QoOTQ4')

# Movies List to be send to the front page to view them.
MOVIES = [THEMASK, TOYSTORY, AVATAR,
          WHITEFANG, TITANIC, TERMINATOR]
